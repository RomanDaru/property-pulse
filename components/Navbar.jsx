...
import { FaGoogle, FaAndroid } from "react-icons/fa";
              ...
              <div className='relative ml-3'>
                ...
                {isProfileMenuOpen && (
                  <div
                    ...
                    <Link
                      href='/profile'
                      className='block px-4 py-2 text-sm text-gray-700 hover:text-blue-700 hover:drop-shadow'
                      onClick={() => {
                        setIsProfileMenuOpen(false);
                      }}
                      role='menuitem'
        ...
        <div id='mobile-menu'>
          <div className='space-y-1 px-2 pb-3 pt-2'>
            <Link
              ...
              } text-white hover:bg-blue-900 hover:text-white block rounded-md px-3 py-2 text-base font-medium`}>
              Home
            </Link>
            <Link
              href='/properties'
