...
const PropertyDetails = ({ property }) => {
  return (
    <main className='dark:text-black'>
      <div className='bg-white dark:bg-purple-300 p-6 rounded-lg shadow-md text-center md:text-left'>
        ...
        <div className='flex flex-col md:flex-row justify-around'>
          <div className='flex items-center justify-center mb-4 border-b border-gray-200 md:border-b-0 pb-4 md:pb-0'>
            <div className='text-gray-500 dark:text-black mr-2 font-bold'>
              Nightly
            </div>
      ...
      <div className='bg-white dark:bg-purple-300 p-6 rounded-lg shadow-md mt-6'>
        ...
        <div className='flex justify-center gap-4 text-blue-500 mb-4 text-xl space-x-9'>
          ...
          <p>
            <FaBath className='mx-auto' /> {property.baths}
        ...
        <p className='text-gray-500 dark:text-black mb-4 mt-8 text-center'>
